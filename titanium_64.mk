...
PRODUCT_COPY_FILES += device/qcom/titanium_32/media/media_profiles_8956.xml:system/etc/media_profiles.xml \
                      device/qcom/titanium_32/media/media_profiles_titanium.xml:system/etc/media_profiles_titanium.xml \
